...
const Header: React.FC<HeaderProps> = ({ theme, toggleTheme, currentUser, onLoginSuccess, onLogout }) => {
  ...
  return (
    <>
      <header className="header-fixed fixed top-0 w-full z-50 shrink-0 transition-[background-color,border-color,box-shadow,backdrop-filter] duration-300 ease-out bg-[color:var(--bg-primary)]/95 backdrop-blur-sm border-b border-border-subtle shadow-md rounded-none">
