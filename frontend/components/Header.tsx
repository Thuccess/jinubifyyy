...
const Header: React.FC<HeaderProps> = ({ theme, toggleTheme, currentUser, onLoginSuccess, onLogout }) => {
  ...
  return (
    <>
      <header className="header-fixed fixed top-0 w-full z-50 shrink-0 transition-[background-color,border-color,box-shadow] duration-300 ease-out bg-bg-primary border-b border-border-subtle shadow-[0_4px_20px_rgba(0,0,0,0.06)] rounded-none">
