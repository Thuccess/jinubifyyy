...
import { ChatBubbleLeftRightIcon, CheckIcon, ArrowRightIcon } from '../../icons/Icons';

const SocialMediaManagementDemo: React.FC = () => {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg sm:text-xl leading-8 text-slate-600 dark:text-slate-400">
              Grow your online presence and engage your audience with professional social media management services
            </p>
          </div>
        </div>
      </div>
          ...
          <AnimatedSection>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                Many businesses struggle with consistent social media posting, engaging content creation, and community management. Our service takes this burden off your shoulders, ensuring your brand stays active, engaging, and growing across all major social platforms.
              </p>
            </div>
          </AnimatedSection>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                'Regular content creation and posting schedules',
                'Community engagement and response management',
                'Page optimization for better visibility',
                'Performance analytics and monthly reports',
                'Multi-platform management (Facebook, Instagram, WhatsApp)'
              ].map((feature, index) => (
          ...
          <AnimatedSection>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400">
                Professional social media management that drives engagement and growth
              </p>
            </div>
            <div className="max-w-4xl mx-auto">
              <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-8 sm:p-12 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <ChatBubbleLeftRightIcon className="h-16 w-16 text-slate-400 dark:text-slate-600 mx-auto mb-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  description: 'Organizations that need to share their mission, engage supporters, and raise awareness about their causes.'
                },
                {
                  title: 'Startups & Growing Businesses',
                  description: 'New businesses that want to build brand awareness and connect with their target audience from day one.'
                }
              ].map((useCase, index) => (
            ...
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 rounded-2xl p-8 sm:p-12">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
                  Let's discuss how our social media management services can help your business connect with your audience and drive growth.
                </p>
...
export default SocialMediaManagementDemo;
