        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg sm:text-xl leading-8 text-slate-600 dark:text-slate-400">
              Create a memorable brand identity that captivates your audience and sets you apart from the competition
            </p>
          </div>
        </div>
      </div>
          ...
          <AnimatedSection>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                Perfect for startups, SMEs, NGOs, and organizations in Juba, South Sudan, and beyond that need professional branding, logo design, and visual identity to establish credibility and connect with their target audience.
              </p>
              <h2 className="text-3xl font-extrabold text-slate-900 dark:text-slate-100 sm:text-4xl mb-6 mt-12">
                What Problem It Solves
              </h2>
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                Many businesses struggle with inconsistent branding, unprofessional visuals, and lack of visual identity. Our graphic design and branding services help you create a cohesive, professional brand that resonates with your audience and builds trust.
              </p>
            </div>
          </AnimatedSection>
        </div>
          ...
          <AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                ...
                'Complete brand identity (colors, fonts, guidelines)',
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-8 sm:p-12 aspect-video flex items-center justify-center">
                <div className="text-center">
                  <PaintBrushIcon className="h-16 w-16 text-slate-400 dark:text-slate-600 mx-auto mb-4" />
              ...
              {[
                {
                  ...
                  description: 'SMEs that need professional branding to compete effectively and build customer trust in the market.'
                },
                {
                  title: 'NGOs & Non-Profits',
                  description: 'Organizations that want to create a strong visual identity to communicate their mission and values effectively.'
                },
                {
                  title: 'Startups & Growing Businesses',
                  description: 'New businesses that need a complete brand identity from logo to marketing materials to launch successfully.'
                }
              ].map((useCase, index) => (
            ...
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 rounded-2xl p-8 sm:p-12">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
                  Let's discuss how our graphic design and branding services can help you create a memorable visual identity.
                </p>
...
export default GraphicDesignDemo;
