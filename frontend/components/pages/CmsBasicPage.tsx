              ...
              <div className="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,1.2fr)]">
                <div className="space-y-6 sm:space-y-8">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div
                      key={i}
                      className="max-w-3xl rounded-xl border border-border-card bg-[color:var(--surface-card)] p-6 sm:p-8 shadow-card"
                    >
                ...
                <aside className="hidden lg:block">
                  <div className="sticky top-28 rounded-xl border border-border-card bg-[color:var(--surface-card)] p-5 space-y-3 shadow-card">
                ...
                {renderedSections.map((section) => {
                  ...
                  return (
                    <PageSection key={section._id} id={section.sectionKey}>
                      <article className="max-w-3xl rounded-xl border border-border-card bg-[color:var(--surface-card)] p-6 sm:p-8 shadow-card">
                        {heading && (
